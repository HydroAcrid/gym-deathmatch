...
export function RecentFeed({
	...
	return (
		<motion.div
			className="paper-card paper-grain ink-edge p-5 flex flex-col gap-4 relative overflow-hidden transition-shadow duration-300 md:sticky md:top-0 md:min-h-[420px]"
