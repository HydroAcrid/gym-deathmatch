...
export function MobileBottomNav() {
	...
	return (
		<>
			<div className="ui2-scope h-[calc(76px+env(safe-area-inset-bottom))] lg:hidden" />
			<nav className="ui2-scope fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-card border-t-2 border-border safe-area-inset-bottom">
